...
//新增選單項目 END
const old_windowTitleCommand_makeCommandList =
  Window_TitleCommand.prototype.makeCommandList;

Window_TitleCommand.prototype.makeCommandList = function () {
  old_windowTitleCommand_makeCommandList.call(this);
  this.addCommand("END", "endGame");
};

Window_TitleCommand.prototype.updatePlacement = function () {
  this.x = ((Graphics.boxWidth - this.width) * 3) / 2;
...
const old_sceneTitle_createCommandWindow =
  Scene_Title.prototype.createCommandWindow;
Scene_Title.prototype.createCommandWindow = function () {
  this._commandWindow = new Window_TitleCommand();
  old_sceneTitle_createCommandWindow.call(this);
